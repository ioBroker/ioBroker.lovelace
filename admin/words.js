...
systemDictionary = {
    ...
    "Entity name '%s' is already in use!": {
        "en": "Entity name '%s' is already in use!",
        "de": "Der Entitätsname '%s' wird bereits verwendet!",
        "ru": "Имя объекта '%s' уже используется!",
        "pt": "O nome da entidade '%s' já está em uso!",
        "nl": "Entiteitsnaam '%s' is al in gebruik!",
        "fr": "Le nom de l'entité '%s' est déjà utilisé!",
        "it": "Il nome dell'entità '%s' è già in uso!",
        "es": "El nombre de la entidad '%s' ya está en uso!",
        "pl": "Nazwa jednostki '%s' jest już w użyciu!",
        "zh-cn": "实体名称'%s'已在使用中!"
    }
};