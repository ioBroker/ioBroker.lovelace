...
const loadConfigFlowDialog = () => Promise.all(/*! import() | dialog-config-flow */[__webpack_require__.e("vendors~dialog-config-flow~hui-dialog-edit-card~hui-dialog-edit-lovelace~hui-dialog-edit-view~hui-di~60dfacf3"), __webpack_require__.e("vendors~dialog-config-flow~more-info-dialog~notification-manager~panel-lovelace"), __webpack_require__.e("vendors~dialog-config-flow~more-info-dialog~onboarding-core-config~panel-lovelace"), __webpack_require__.e("vendors~dialog-config-flow~more-info-dialog~panel-lovelace"), __webpack_require__.e("vendors~dialog-config-flow~more-info-dialog~onboarding-core-config"), __webpack_require__.e("vendors~dialog-config-flow~more-info-dialog"), __webpack_require__.e("vendors~dialog-config-flow~panel-lovelace"), __webpack_require__.e("dialog-config-flow")]).then(__webpack_require__.bind(null, /*! ./dialog-config-flow */ "./src/dialogs/config-flow/dialog-config-flow.ts"));
  ...
  return {
    ...
    d: [{
      ...
      value: function connectedCallback() {
        ...
        this.hass.connection.subscribeEvents(Object(_common_util_debounce__WEBPACK_IMPORTED_MODULE_6__["debounce"])(() => this._loadData(), 500), "config_entry_discovered").then(unsub => {
      ...
      value: function render() {
        ...
        const discovered = this._discovered.map(flow => {
          const title = Object(_data_config_entries__WEBPACK_IMPORTED_MODULE_3__["localizeConfigFlowTitle"])(this.hass.localize, flow);
          return [title, lit_element__WEBPACK_IMPORTED_MODULE_0__["html"]`
    ...
    `;
      ...
      kind: "method",
      key: "_loadData",
      value: async function _loadData() {
        const [discovered, entries] = await Promise.all([Object(_data_config_entries__WEBPACK_IMPORTED_MODULE_3__["getConfigFlowsInProgress"])(this.hass), Object(_data_config_entries__WEBPACK_IMPORTED_MODULE_3__["getConfigEntries"])(this.hass)]);
