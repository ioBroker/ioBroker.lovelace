(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["vendors~jquery-roundslider"],{
...
(function ($, window, undefined) {
  ...
  function CreateRoundSlider(n, t) {
    for (var i, r, u, f = 0; f < this.length; f++) if (i = this[f], r = $.data(i, pluginName), r) {
  ...
  $.fn[pluginName] = function (n) {
    ...
    _checkKO: function () {
      ...
      if (typeof f == "string" && typeof ko == "object") {
        ...
        for (i = f.split(","), n = 0; n < i.length; n++) if (u = i[n].split(":"), $.trim(u[0]) == "value") {
          r = $.trim(u[1]);
          break;
        }
    ...
    _isBrowserSupported: function () {
      for (var t = ["borderRadius", "WebkitBorderRadius", "MozBorderRadius", "OBorderRadius", "msBorderRadius", "KhtmlBorderRadius"], n = 0; n < t.length; n++) if (document.body.style[t[n]] !== undefined) return !0;
    },
...
//# sourceMappingURL=vendors~jquery-roundslider.chunk.js.map