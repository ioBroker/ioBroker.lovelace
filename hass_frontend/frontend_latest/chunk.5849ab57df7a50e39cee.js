/*! For license information please see chunk.5849ab57df7a50e39cee.js.LICENSE */
...
`,is:"paper-dialog-scrollable",properties:{dialogElement:{type:Object}},get scrollTarget(){return this.$.scrollable},ready:function(){this._ensureTarget(),this.classList.add("no-padding")},attached:function(){this._ensureTarget(),requestAnimationFrame(this.updateScrollState.bind(this))},updateScrollState:function(){this.toggleClass("is-scrolled",this.scrollTarget.scrollTop>0),this.toggleClass("can-scroll",this.scrollTarget.offsetHeight<this.scrollTarget.scrollHeight),this.toggleClass("scrolled-to-bottom",this.scrollTarget.scrollTop+this.scrollTarget.offsetHeight>=this.scrollTarget.scrollHeight)},_ensureTarget:function(){this.dialogElement=this.dialogElement||this.parentElement,this.dialogElement&&this.dialogElement.behaviors&&this.dialogElement.behaviors.indexOf(n.b)>=0?(this.dialogElement.sizingTarget=this.scrollTarget,this.scrollTarget.classList.remove("fit")):this.dialogElement&&this.scrollTarget.classList.add("fit")}})},702:function(t,i,e){"use strict";e.r(i),e.d(i,"CloudWebhookManageDialog",function(){return l});var n=e(1),o=(e(82),e(90),e(201),e(191),e(54));function a(t,i,e){return i in t?Object.defineProperty(t,i,{value:e,enumerable:!0,configurable:!0,writable:!0}):t[i]=e,t}const s="Public URL – Click to copy to clipboard";class l extends n.a{constructor(...t){super(...t),a(this,"hass",void 0),a(this,"_params",void 0)}static get properties(){return{_params:{}}}async showDialog(t){this._params=t,await this.updateComplete,this._dialog.open()}render(){if(!this._params)return n.e``;const{webhook:t,cloudhook:i}=this._params,e="automation"===t.domain?"https://www.home-assistant.io/docs/automation/trigger/#webhook-trigger":`https://www.home-assistant.io/components/${t.domain}/`;return n.e`
    ...
    `}get _dialog(){return this.shadowRoot.querySelector("ha-paper-dialog")}get _paperInput(){return this.shadowRoot.querySelector("paper-input")}_closeDialog(){this._dialog.close()}async _disableWebhook(){confirm("Are you sure you want to disable this webhook?")&&(this._params.disableHook(),this._closeDialog())}_copyClipboard(t){const i=t.currentTarget,e=i.inputElement.inputElement;e.setSelectionRange(0,e.value.length);try{document.execCommand("copy"),i.label="COPIED TO CLIPBOARD"}catch(n){}}_restoreLabel(){this._paperInput.label=s}static get styles(){return[o.a,n.c`
      ...
      `]}}customElements.define("cloud-webhook-manage-dialog",l)}}]);
//# sourceMappingURL=chunk.5849ab57df7a50e39cee.js.map