/*! For license information please see chunk.154738b910fb4a8fc017.js.LICENSE */
(self.webpackJsonp=self.webpackJsonp||[]).push([[80],{142:function(t,i){t.exports=function(t,i){var e=0,n={};t.addEventListener("message",function(i){var e=i.data;if("RPC"===e.type)if(e.id){var a=n[e.id];a&&(delete n[e.id],e.error?a[1](Object.assign(Error(e.error.message),e.error)):a[0](e.result))}else{var o=document.createEvent("Event");o.initEvent(e.method,!1,!1),o.data=e.params,t.dispatchEvent(o)}}),i.forEach(function(i){t[i]=function(){for(var a=[],o=arguments.length;o--;)a[o]=arguments[o];return new Promise(function(o,s){var r=++e;n[r]=[o,s],t.postMessage({type:"RPC",id:r,method:i,params:a})})}})}},214:function(t,i,e){"use strict";e(5);var n=e(6),a=e(2),o=e(4);Object(n.a)({_template:o.a`
    <style>
      :host {
        display: block;
        position: absolute;
...
//# sourceMappingURL=chunk.154738b910fb4a8fc017.js.map