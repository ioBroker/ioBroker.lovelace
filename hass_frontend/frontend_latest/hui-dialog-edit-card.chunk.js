...
let HuiDialogEditCard = _decorate([Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["customElement"])("hui-dialog-edit-card")], function (_initialize, _LitElement) {
  ...
  return {
    ...
    `;
      ...
      kind: "method",
      key: "_save",
      value: async function _save(cardConf) {
        const lovelace = this._params.lovelace;
        await lovelace.saveConfig(this._params.path.length === 1 ? Object(_config_util__WEBPACK_IMPORTED_MODULE_3__["addCard"])(lovelace.config, this._params.path, cardConf) : Object(_config_util__WEBPACK_IMPORTED_MODULE_3__["replaceCard"])(lovelace.config, this._params.path, cardConf));
      }
    }]
  };
}, lit_element__WEBPACK_IMPORTED_MODULE_0__["LitElement"]);
...
let HuiDialogPickCard = _decorate([Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["customElement"])("hui-dialog-pick-card")], function (_initialize, _LitElement) {
  class HuiDialogPickCard extends _LitElement {
    constructor(...args) {
      super(...args);
...
let HuiEditCard = _decorate([Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["customElement"])("hui-edit-card")], function (_initialize, _LitElement) {
  class HuiEditCard extends _LitElement {
    // tslint:disable-next-line
    constructor() {
      super();
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        <div class="element-editor">
          ${this._uiEditor ? this._configElement : lit_element__WEBPACK_IMPORTED_MODULE_0__["html"]`
                <hui-yaml-editor
                  .hass="${this.hass}"
      ...
      `;
          preview = lit_element__WEBPACK_IMPORTED_MODULE_0__["html"]`
      ...
      >
        ...
        ${!this._loading ? lit_element__WEBPACK_IMPORTED_MODULE_0__["html"]`
              <div class="paper-dialog-buttons">
                <mwc-button
                  class="toggle-button"
                  ?disabled="${this._configElement === null || this._configState !== "OK"}"
    ...
    `;
      ...
      kind: "method",
      key: "_loadedDialog",
      value: async function _loadedDialog() {
        ...
        if (!this._uiEditor) {
          Object(_common_util_render_status__WEBPACK_IMPORTED_MODULE_13__["afterNextRender"])(() => {
      ...
      kind: "method",
      key: "_updatePreview",
      value: async function _updatePreview(config) {
        await this.updateComplete;
      ...
      kind: "method",
      key: "_toggleEditor",
      value: async function _toggleEditor() {
        this._cardYaml = undefined;
      ...
      value: async function _loadConfigElement(conf) {
        if (!conf) {
          return false;
        }
        ...
        this._loading = true;
        this._configElement = undefined;
        const tag = Object(_common_get_card_element_tag__WEBPACK_IMPORTED_MODULE_12__["getCardElementTag"])(conf.type);
        const elClass = customElements.get(tag);
        let configElement;
      ...
      `;
        ...
        configElement.addEventListener("config-changed", ev => this._handleUIConfigChanged(ev.detail.config));
