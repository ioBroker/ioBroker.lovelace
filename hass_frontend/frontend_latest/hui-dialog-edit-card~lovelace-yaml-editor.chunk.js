...
let HuiYamlEditor = _decorate([Object(lit_element__WEBPACK_IMPORTED_MODULE_5__["customElement"])("hui-yaml-editor")], function (_initialize, _HTMLElement) {
  class HuiYamlEditor extends _HTMLElement {
    constructor() {
      ...
      shadowRoot.innerHTML = `
            <style>
              ${codemirror_lib_codemirror_css__WEBPACK_IMPORTED_MODULE_2__["default"]}
              .CodeMirror {
