      ...
      <hui-generic-entity-row .hass=${this.hass} .config=${this._config}>
        ${"slider"===e.attributes.mode?i.dy`
              <div class="flex">
                ...
                ></ha-slider>
                <span class="state">
                  ${(0,n.u)(Number(e.state),this.hass.locale)}
...
//# sourceMappingURL=chunk.03049eab249f166a5ab5.js.map