(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["vendors~panel-config-person~panel-config-users"],{
...
//# sourceMappingURL=vendors~panel-config-person~panel-config-users.chunk.js.map