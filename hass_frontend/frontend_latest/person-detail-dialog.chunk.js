    ...
    d: [{
      ...
      value() {
        return Object(memoize_one__WEBPACK_IMPORTED_MODULE_6__["default"])(users => {
          ...
          const sorted = [...users];
          sorted.sort((a, b) => Object(_common_string_compare__WEBPACK_IMPORTED_MODULE_10__["compare"])(a.name, b.name));
          return sorted;
        });
      }
...
let DialogPersonDetail = _decorate(null, function (_initialize, _LitElement) {
  ...
  return {
    ...
    `;
      ...
      key: "styles",
      value: function styles() {
        return [_resources_styles__WEBPACK_IMPORTED_MODULE_7__["haStyleDialog"], lit_element__WEBPACK_IMPORTED_MODULE_0__["css"]`
        ha-paper-dialog {
          min-width: 400px;
        }
        .form {
