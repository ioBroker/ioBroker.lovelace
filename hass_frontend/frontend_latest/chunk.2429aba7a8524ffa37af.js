    ...
    `}static get properties(){return{hass:{type:Object,value:null},disabled:{type:Boolean,value:!1},pushChecked:{type:Boolean,value:"Notification"in window&&"granted"===Notification.permission},loading:{type:Boolean,value:!0}}}async connectedCallback(){if(super.connectedCallback(),J)try{const e=await navigator.serviceWorker.ready;if(!e.pushManager)return;e.pushManager.getSubscription().then(e=>{this.loading=!1,this.pushChecked=!!e})}catch(e){}}handlePushChange(e){J&&(e.target.checked?this.subscribePushNotifications():this.unsubscribePushNotifications())}async subscribePushNotifications(){const e=await navigator.serviceWorker.ready;let t;try{let r;r=navigator.userAgent.toLowerCase().indexOf("firefox")>-1?"firefox":"chrome";const n=prompt("What should this device be called ?");if(null==n)return void(this.pushChecked=!1);let o;try{o=await Z(this.hass)}catch(i){o=null}t=o?await e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:o}):await e.pushManager.subscribe({userVisibleOnly:!0}),await this.hass.callApi("POST","notify.html5",{subscription:t,browser:r,name:n})}catch(r){const e=r.message||"Notification registration failed.";t&&await t.unsubscribe(),console.error(r),this.fire("hass-notification",{message:e}),this.pushChecked=!1}}async unsubscribePushNotifications(){const e=await navigator.serviceWorker.ready;try{const t=await e.pushManager.getSubscription();if(!t)return;await this.hass.callApi("DELETE","notify.html5",{subscription:t}),await t.unsubscribe()}catch(t){const e=t.message||"Failed unsubscribing for push notifications.";console.error("Error in unsub push",t),this.fire("hass-notification",{message:e}),this.pushChecked=!0}}_compDisabled(e,t){return e||t}}customElements.define("ha-push-notifications-toggle",G);class Q extends(Object(g.a)(d.a)){static get template(){return c.a`
      ...
      <ha-settings-row narrow="[[narrow]]">
        ...
        <span slot="description">
          ...
          <a
            href="https://embed.windy.com/embed2.html?lat=32.487&lon=-84.023&zoom=5&level=surface&overlay=rain&menu=&message=&marker=&calendar=&pressure=&type=map&location=coordinates&detail=&detailLat=32.487&detailLon=--84.023&metricWind=default&metricTemp=default&radarRange=-1/integrations/html5"
            target="_blank"
            rel="noreferrer"
