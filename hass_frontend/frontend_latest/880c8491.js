"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[24474],{96305:(e,t,r)=>{r.d(t,{v:()=>i});const i=(e,t)=>e&&Object.keys(e.services).filter((r=>t in e.services[r]))},54909:(e,t,r)=>{var i=r(50856),o=r(28426),n=r(26765),s=r(11052);r(98762);class a extends((0,s.I)(o.H3)){static get template(){return i.d`
      <ha-progress-button
        id="progress"
        progress="[[progress]]"
        disabled="[[disabled]]"
          ...
          ${this._reloadableDomains.map((e=>i.dy`
                <div class="card-actions">
                  <ha-call-service-button
                    ...
                    .domain=${e}
                    service="reload"
                    >${this.hass.localize(`ui.panel.developer-tools.tabs.yaml.section.reloading.${e}`)||this.hass.localize("ui.panel.developer-tools.tabs.yaml.section.reloading.reload","domain",(0,a.Lh)(this.hass.localize,e))}
                  </ha-call-service-button>
                </div>
              `))}
        </ha-card>
      </div>
    `}},{kind:"method",key:"_validateConfig",value:async function(){this._validating=!0,this._validateLog="",this._isValid=null;const e=await(0,s.Ij)(this.hass);this._validating=!1,this._isValid="valid"===e.result,e.errors&&(this._validateLog=e.errors)}},{kind:"method",key:"_restart",value:function(){(0,l.g7)(this,{title:this.hass.localize("ui.panel.developer-tools.tabs.yaml.section.server_management.confirm_restart_title"),text:this.hass.localize("ui.panel.developer-tools.tabs.yaml.section.server_management.confirm_restart_text"),confirmText:this.hass.localize("ui.panel.developer-tools.tabs.yaml.section.server_management.restart"),confirm:()=>{this.hass.callService("homeassistant","restart").catch((e=>{this._isValid=!1,this._validateLog=e.message}))}})}},{kind:"get",static:!0,key:"styles",value:function(){return[c.Qx,i.iv`
        .validate-container {
          height: 60px;
        }
      ...
      `]}}]}}),i.oi)}}]);
//# sourceMappingURL=880c8491.js.map