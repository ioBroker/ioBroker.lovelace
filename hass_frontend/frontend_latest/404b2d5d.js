...
`,E=e=>/.+\.png|\.svg|\.jpg|\.jpeg/i.test(e),_=(e,t,r,o)=>{const s=getComputedStyle(t).getPropertyValue(`--weather-icon-${e}`);if(s)return i.dy`
  ...
  ${p.has(e)?i.YP`
    ...
    `}}]}}),i.oi)}}]);
//# sourceMappingURL=404b2d5d.js.map