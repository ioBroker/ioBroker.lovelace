/*! For license information please see chunk.afb802081e8f2044be2e.js.LICENSE */
(self.webpackJsonp=self.webpackJsonp||[]).push([[158],{151:function(t,i){t.exports=function(t,i){var e=0,n={};t.addEventListener("message",(function(i){var e=i.data;if("RPC"===e.type)if(e.id){var a=n[e.id];a&&(delete n[e.id],e.error?a[1](Object.assign(Error(e.error.message),e.error)):a[0](e.result))}else{var o=document.createEvent("Event");o.initEvent(e.method,!1,!1),o.data=e.params,t.dispatchEvent(o)}})),i.forEach((function(i){t[i]=function(){for(var a=[],o=arguments.length;o--;)a[o]=arguments[o];return new Promise((function(o,s){var r=++e;n[r]=[o,s],t.postMessage({type:"RPC",id:r,method:i,params:a})}))}}))}},248:function(t,i,e){"use strict";e(3);var n=e(5),a=e(2),o=e(4);Object(n.a)({_template:o.a`
    <style>
      :host {
        display: block;
        position: absolute;
...
//# sourceMappingURL=chunk.afb802081e8f2044be2e.js.map