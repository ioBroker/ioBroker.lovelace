...
<custom-style>
  ...
  `,behaviors:[r.a,o.a],properties:{value:{type:String}},get _focusableElement(){return this.inputElement._inputElement},listeners:{"iron-input-ready":"_onIronInputReady"},_onIronInputReady:function(){this.$.nativeInput||(this.$.nativeInput=this.$$("input")),this.inputElement&&-1!==this._typesThatHaveText.indexOf(this.$.nativeInput.type)&&(this.alwaysFloatLabel=!0),this.inputElement.bindValue&&this.$.container._handleValueAndAutoValidate(this.inputElement)}})},function(e,t,n){"use strict";function o(e){const t=e.language||"en";return e.translationMetadata.translations[t]&&e.translationMetadata.translations[t].isRTL||!1}function a(e){return o(e)?"rtl":"ltr"}n.d(t,"a",function(){return o}),n.d(t,"b",function(){return a})},,function(e,t,n){"use strict";n.d(t,"a",function(){return a});const o=e=>{const t=e.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,(e,t,n,o)=>t+t+n+n+o+o),n=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t);return n?`${parseInt(n[1],16)}, ${parseInt(n[2],16)}, ${parseInt(n[3],16)}`:null};function a(e,t,n,a=!1){e._themes||(e._themes={});let i=t.default_theme;("default"===n||n&&t.themes[n])&&(i=n);const r=Object.assign({},e._themes);if("default"!==i){const n=t.themes[i];Object.keys(n).forEach(t=>{const a=`--${t}`;if(e._themes[a]="",r[a]=n[t],t.startsWith("rgb"))return;const i=`rgb-${t}`;if(void 0!==n[i])return;const s=`--${i}`;e._themes[s]="";const l=o(n[t]);null!==l&&(r[s]=l)})}if(e.updateStyles?e.updateStyles(r):window.ShadyCSS&&window.ShadyCSS.styleSubtree(e,r),!a)return;const s=document.querySelector("meta[name=theme-color]");if(s){s.hasAttribute("default-content")||s.setAttribute("default-content",s.getAttribute("content"));const e=r["--primary-color"]||s.getAttribute("default-content");s.setAttribute("content",e)}}},function(e,t,n){"use strict";n.d(t,"a",function(){return i});n(5);var o=n(6),a=n(4);const i=Object(o.a)({_template:a.a`
    <style>
      :host {
...
`,is:"paper-input-error",behaviors:[i.a],properties:{invalid:{readOnly:!0,reflectToAttribute:!0,type:Boolean}},update:function(e){this._setInvalid(e.invalid)}})},function(e,t,n){"use strict";n(5);var o=n(96),a=n(61),i=n(6),r=n(2),s=n(4);Object(i.a)({_template:s.a`
    <style>
      :host {
        display: inline-block;
      }
...
`}firstUpdated(e){super.firstUpdated(e),setTimeout(()=>this.shadowRoot.querySelector("paper-input").focus(),100),this.addEventListener("keypress",e=>{13===e.keyCode&&this._submitForm(e)})}_handleValueChanged(e){this[`_${e.target.name}`]=e.detail.value}_maybePopulateUsername(){if(this._username)return;const e=this._name.split(" ");e.length&&(this._username=e[0].toLowerCase())}async _submitForm(e){if(e.preventDefault(),this._name&&this._username&&this._password)if(this._password===this._passwordConfirm){this._loading=!0,this._errorMsg="";try{const e=Object(i.f)(),n=await Object(s.d)({client_id:e,name:this._name,username:this._username,password:this._password,language:this.language});Object(c.a)(this,"onboarding-step",{type:"user",result:n})}catch(t){console.error(t),this._loading=!1,this._errorMsg=t.body.message}}else this._errorMsg="password_not_match";else this._errorMsg="required_fields"}static get styles(){return a.c`
    ...
    `}};o.b([Object(a.f)()],d.prototype,"localize",void 0),o.b([Object(a.f)()],d.prototype,"language",void 0),o.b([Object(a.f)()],d.prototype,"_name",void 0),o.b([Object(a.f)()],d.prototype,"_username",void 0),o.b([Object(a.f)()],d.prototype,"_password",void 0),o.b([Object(a.f)()],d.prototype,"_passwordConfirm",void 0),o.b([Object(a.f)()],d.prototype,"_loading",void 0),o.b([Object(a.f)()],d.prototype,"_errorMsg",void 0),d=o.b([Object(a.d)("onboarding-create-user")],d);let p=class extends a.a{render(){return a.e`
    ...
    `}};p=o.b([Object(a.d)("onboarding-loading")],p);var u=n(64),f=n(106),h=n(116),b=n(59);let g=class extends(Object(r.a)(f.a)){constructor(){super(...arguments),this.translationFragment="page-onboarding",this._loading=!1}render(){const e=this._curStep();return this._loading||!e?a.e`
