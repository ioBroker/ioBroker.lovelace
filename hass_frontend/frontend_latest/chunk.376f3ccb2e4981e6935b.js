...
`},693:function(t,e,i){"use strict";i.r(e),i.d(e,"HuiPlantStatusCardEditor",(function(){return r}));var n=i(4),a=i(0),s=(i(93),i(190),i(179),i(199)),o=i(18),c=i(205);const l=Object(s.a)({type:"string",entity:"string",name:"string?"});let r=class extends a.a{setConfig(t){t=l(t),this._config=t}get _entity(){return this._config.entity||""}get _name(){return this._config.name||""}render(){return this.hass?a.f`
      ${c.a}
