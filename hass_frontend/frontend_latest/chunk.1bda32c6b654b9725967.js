...
`},683:function(t,e,i){"use strict";i.r(e),i.d(e,"HuiAlarmPanelCardEditor",(function(){return r}));var a=i(4),s=i(0),n=(i(146),i(143),i(144),i(199)),o=i(18),c=i(205);i(190),i(179);const l=Object(n.a)({type:"string",entity:"string?",name:"string?",states:"array?"});let r=class extends s.a{setConfig(t){t=l(t),this._config=t}get _entity(){return this._config.entity||""}get _name(){return this._config.name||""}get _states(){return this._config.states||[]}render(){if(!this.hass)return s.f``;return s.f`
      ${c.a}
