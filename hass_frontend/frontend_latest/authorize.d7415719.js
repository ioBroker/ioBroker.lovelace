...
`,is:"paper-input-error",behaviors:[r.a],properties:{invalid:{readOnly:!0,reflectToAttribute:!0,type:Boolean}},update:function(e){this._setInvalid(e.invalid)}})},function(e,t,n){"use strict";n(5);var i=n(96),o=n(61),r=n(6),a=n(2),s=n(4);Object(r.a)({_template:s.a`
    <style>
      :host {
        display: inline-block;
      }
...
`,is:"paper-menu-button",behaviors:[i.a,o.a],properties:{opened:{type:Boolean,value:!1,notify:!0,observer:"_openedChanged"},horizontalAlign:{type:String,value:"left",reflectToAttribute:!0},verticalAlign:{type:String,value:"top",reflectToAttribute:!0},dynamicAlign:{type:Boolean},horizontalOffset:{type:Number,value:0,notify:!0},verticalOffset:{type:Number,value:0,notify:!0},noOverlap:{type:Boolean},noAnimations:{type:Boolean,value:!1},ignoreSelect:{type:Boolean,value:!1},closeOnActivate:{type:Boolean,value:!1},openAnimationConfig:{type:Object,value:function(){return[{name:"fade-in-animation",timing:{delay:100,duration:200}},{name:"paper-menu-grow-width-animation",timing:{delay:100,duration:150,easing:p.ANIMATION_CUBIC_BEZIER}},{name:"paper-menu-grow-height-animation",timing:{delay:100,duration:275,easing:p.ANIMATION_CUBIC_BEZIER}}]}},closeAnimationConfig:{type:Object,value:function(){return[{name:"fade-out-animation",timing:{duration:150}},{name:"paper-menu-shrink-width-animation",timing:{delay:100,duration:50,easing:p.ANIMATION_CUBIC_BEZIER}},{name:"paper-menu-shrink-height-animation",timing:{duration:200,easing:"ease-in"}}]}},allowOutsideScroll:{type:Boolean,value:!1},restoreFocusOnClose:{type:Boolean,value:!0},_dropdownContent:{type:Object}},hostAttributes:{role:"group","aria-haspopup":"true"},listeners:{"iron-activate":"_onIronActivate","iron-select":"_onIronSelect"},get contentElement(){for(var e=Object(l.a)(this.$.content).getDistributedNodes(),t=0,n=e.length;t<n;t++)if(e[t].nodeType===Node.ELEMENT_NODE)return e[t]},toggle:function(){this.opened?this.close():this.open()},open:function(){this.disabled||this.$.dropdown.open()},close:function(){this.$.dropdown.close()},_onIronSelect:function(e){this.ignoreSelect||this.close()},_onIronActivate:function(e){this.closeOnActivate&&this.close()},_openedChanged:function(e,t){e?(this._dropdownContent=this.contentElement,this.fire("paper-dropdown-open")):null!=t&&this.fire("paper-dropdown-close")},_disabledChanged:function(e){o.a._disabledChanged.apply(this,arguments),e&&this.opened&&this.close()},__onIronOverlayCanceled:function(e){var t=e.detail,n=this.$.trigger;Object(l.a)(t).path.indexOf(n)>-1&&e.preventDefault()}});Object.keys(p).forEach(function(e){u[e]=p[e]})},,function(e,t,n){"use strict";n(89);const i=document.createElement("template");i.setAttribute("style","display: none;"),i.innerHTML='<iron-iconset-svg name="paper-dropdown-menu" size="24">\n<svg><defs>\n<g id="arrow-drop-down"><path d="M7 10l5 5 5-5z"></path></g>\n</defs></svg>\n</iron-iconset-svg>',document.head.appendChild(i.content)},function(e,t,n){"use strict";n(42);const i=document.createElement("template");i.setAttribute("style","display: none;"),i.innerHTML='<dom-module id="paper-dropdown-menu-shared-styles">\n  <template>\n    <style>\n      :host {\n        display: inline-block;\n        position: relative;\n        text-align: left;\n\n        /* NOTE(cdata): Both values are needed, since some phones require the\n         * value to be `transparent`.\n         */\n        -webkit-tap-highlight-color: rgba(0,0,0,0);\n        -webkit-tap-highlight-color: transparent;\n\n        --paper-input-container-input: {\n          overflow: hidden;\n          white-space: nowrap;\n          text-overflow: ellipsis;\n          max-width: 100%;\n          box-sizing: border-box;\n          cursor: pointer;\n        };\n\n        @apply --paper-dropdown-menu;\n      }\n\n      :host([disabled]) {\n        @apply --paper-dropdown-menu-disabled;\n      }\n\n      :host([noink]) paper-ripple {\n        display: none;\n      }\n\n      :host([no-label-float]) paper-ripple {\n        top: 8px;\n      }\n\n      paper-ripple {\n        top: 12px;\n        left: 0px;\n        bottom: 8px;\n        right: 0px;\n\n        @apply --paper-dropdown-menu-ripple;\n      }\n\n      paper-menu-button {\n        display: block;\n        padding: 0;\n\n        @apply --paper-dropdown-menu-button;\n      }\n\n      paper-input {\n        @apply --paper-dropdown-menu-input;\n      }\n\n      iron-icon {\n        color: var(--disabled-text-color);\n\n        @apply --paper-dropdown-menu-icon;\n      }\n    </style>\n  </template>\n</dom-module>',document.head.appendChild(i.content)},function(e,t,n){"use strict";n(147),n(140),n(107),n(92),n(137),n(138);var i=n(4),o=n(31),r=(n(144),n(117));customElements.define("ha-form",class extends(Object(r.a)(o.a)){static get template(){return i.a`
    ...
    `}firstUpdated(e){if(super.firstUpdated(e),null==this.clientId||null==this.redirectUri)return console.error("clientId and redirectUri must not be null",this.clientId,this.redirectUri),this._state="error",void(this._errorMessage=this._unknownError());this.addEventListener("keypress",e=>{13===e.keyCode&&this._handleSubmit(e)})}updated(e){super.updated(e),e.has("authProvider")&&this._providerChanged(this.authProvider)}_renderForm(){switch(this._state){case"step":return null==this._step?r.e``:r.e`
        ...
        `}}_renderStep(e){switch(e.type){case"abort":return r.e`
        ...
        `;case"form":return r.e`
          ...
          ></ha-form>
        `;default:return r.e``}}async _providerChanged(e){if(this._step&&"form"===this._step.type&&fetch(`/auth/login_flow/${this._step.flow_id}`,{method:"DELETE",credentials:"same-origin"}).catch(e=>{console.error("Error delete obsoleted auth flow",e)}),null==e)return console.error("No auth provider"),this._state="error",void(this._errorMessage=this._unknownError());try{const n=await fetch("/auth/login_flow",{method:"POST",credentials:"same-origin",body:JSON.stringify({client_id:this.clientId,handler:[e.type,e.id],redirect_uri:this.redirectUri})}),i=await n.json();if(n.ok){if("create_entry"===i.type)return void this._redirect(i.result);await this._updateStep(i)}else this._state="error",this._errorMessage=i.message}catch(t){console.error("Error starting auth flow",t),this._state="error",this._errorMessage=this._unknownError()}}_redirect(e){let t=this.redirectUri;t.includes("?")?t.endsWith("&")||(t+="&"):t+="?",t+=`code=${encodeURIComponent(e)}`,this.oauth2State&&(t+=`&state=${encodeURIComponent(this.oauth2State)}`),document.location.assign(t)}async _updateStep(e){let t=null;this._step&&(e.flow_id!==this._step.flow_id||"form"===e.type&&"form"===this._step.type&&e.step_id!==this._step.step_id)&&(t={}),this._step=e,this._state="step",null!=t&&(this._stepData=t),await this.updateComplete,setTimeout(()=>{const e=this.shadowRoot.querySelector("ha-form");e&&e.focus()},100)}_computeStepDescription(e){const t=`ui.panel.page-authorize.form.providers.${e.handler[0]}.step.${e.step_id}.description`,n=[],i=e.description_placeholders||{};return Object.keys(i).forEach(e=>{n.push(e),n.push(i[e])}),this.localize(t,...n)}_computeLabelCallback(e){return t=>this.localize(`ui.panel.page-authorize.form.providers.${e.handler[0]}.step.${e.step_id}.data.${t.name}`)}_computeErrorCallback(e){return t=>this.localize(`ui.panel.page-authorize.form.providers.${e.handler[0]}.error.${t}`)}_unknownError(){return this.localize("ui.panel.page-authorize.form.unknown_error")}async _handleSubmit(e){if(e.preventDefault(),null==this._step)return;if("form"!==this._step.type)return void this._providerChanged(this.authProvider);this._state="loading",this.style.setProperty("min-height",`${this.offsetHeight}px`);const t=Object.assign({},this._stepData,{client_id:this.clientId});try{const e=await fetch(`/auth/login_flow/${this._step.flow_id}`,{method:"POST",credentials:"same-origin",body:JSON.stringify(t)}),i=await e.json();if("create_entry"===i.type)return void this._redirect(i.result);await this._updateStep(i)}catch(n){console.error("Error submitting step",n),this._state="error",this._errorMessage=this._unknownError()}finally{this.style.setProperty("min-height","")}}static get styles(){return r.c`
      :host {
    ...
    `}}i.b([Object(r.f)()],a.prototype,"authProvider",void 0),i.b([Object(r.f)()],a.prototype,"clientId",void 0),i.b([Object(r.f)()],a.prototype,"redirectUri",void 0),i.b([Object(r.f)()],a.prototype,"oauth2State",void 0),i.b([Object(r.f)()],a.prototype,"_state",void 0),i.b([Object(r.f)()],a.prototype,"_stepData",void 0),i.b([Object(r.f)()],a.prototype,"_step",void 0),i.b([Object(r.f)()],a.prototype,"_errorMessage",void 0),customElements.define("ha-auth-flow",a);var s=n(64),l=n(77);n.e(57).then(n.bind(null,339));class c extends(Object(o.a)(r.a)){constructor(){super(),this.translationFragment="page-authorize";const e={},t=location.search.substr(1).split("&");for(const n of t){const t=n.split("=");t.length>1&&(e[decodeURIComponent(t[0])]=decodeURIComponent(t[1]))}e.client_id&&(this.clientId=e.client_id),e.redirect_uri&&(this.redirectUri=e.redirect_uri),e.state&&(this.oauth2State=e.state)}static get properties(){return{_authProvider:{},_authProviders:{},clientId:{},redirectUri:{},oauth2State:{}}}render(){if(!this._authProviders)return r.e`
      ...
      ${t.length>0?r.e`
            ...
            ></ha-pick-auth-provider>
          `:""}
    `}firstUpdated(e){if(super.firstUpdated(e),this._fetchAuthProviders(),!this.redirectUri)return;const t=document.createElement("a");t.href=this.redirectUri,t.host===location.host&&Object(l.a)(!1)}async _fetchAuthProviders(){try{const t=await(window.providersPromise||Object(s.a)()),n=await t.json();if(400===t.status&&"onboarding_required"===n.code)return void(location.href="/?");if(0===n.length)return void alert("No auth providers returned. Unable to finish login.");this._authProviders=n,this._authProvider=n[0]}catch(e){console.error("Error loading auth providers",e)}}async _handleAuthProviderPick(e){this._authProvider=e.detail}static get styles(){return r.c`
      ha-pick-auth-provider {
        display: block;
        margin-top: 48px;
      }
    `}}i.b([Object(r.f)()],c.prototype,"clientId",void 0),i.b([Object(r.f)()],c.prototype,"redirectUri",void 0),i.b([Object(r.f)()],c.prototype,"oauth2State",void 0),i.b([Object(r.f)()],c.prototype,"_authProvider",void 0),i.b([Object(r.f)()],c.prototype,"_authProviders",void 0),customElements.define("ha-authorize",c),setTimeout(()=>n.e(77).then(n.t.bind(null,337,7)),2e3)}]);
//# sourceMappingURL=authorize.d7415719.js.map