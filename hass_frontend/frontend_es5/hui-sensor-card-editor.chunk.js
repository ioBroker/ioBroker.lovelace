(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["hui-sensor-card-editor"],{
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject2(), _config_elements_style__WEBPACK_IMPORTED_MODULE_9__["configElementStyle"], this._name, "name", this._valueChanged, this.hass, this._entity, "entity", this._valueChanged, this._icon, "icon", this._valueChanged, "graph", this._valueChanged, graphs.indexOf(this._graph), graphs.map(function (graph) {
          return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject3(), graph);
        }), this._unit, "unit", this._valueChanged, this._detail, "detail", this._valueChanged, this.hass, this._theme, "theme", this._valueChanged, this._hours_to_show, "hours_to_show", this._valueChanged);
      }
    }, {
      kind: "method",
      key: "_valueChanged",
...
//# sourceMappingURL=hui-sensor-card-editor.chunk.js.map