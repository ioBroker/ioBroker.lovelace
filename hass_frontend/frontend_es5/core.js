...
var userCollection = function userCollection(conn) {
  return Object(home_assistant_js_websocket__WEBPACK_IMPORTED_MODULE_0__["getCollection"])(conn, "_usr", function () {
    return Object(home_assistant_js_websocket__WEBPACK_IMPORTED_MODULE_0__["getUser"])(conn);
  }, undefined);
};
...
var authProm = isExternal ? function () {
  return __webpack_require__.e(/*! import() | external_auth */ "external_auth").then(__webpack_require__.bind(null, /*! ../external_app/external_auth */ "./src/external_app/external_auth.ts")).then(function (_ref) {
    var createExternalAuth = _ref.createExternalAuth;
    return createExternalAuth(_data_auth__WEBPACK_IMPORTED_MODULE_5__["hassUrl"]);
  });
} : function () {
  return Object(home_assistant_js_websocket__WEBPACK_IMPORTED_MODULE_0__["getAuth"])({
...
var connProm = function connProm(auth) {
  var conn, _conn;

  return regeneratorRuntime.async(function connProm$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return regeneratorRuntime.awrap(Object(home_assistant_js_websocket__WEBPACK_IMPORTED_MODULE_0__["createConnection"])({
            auth: auth
          }));
        ...
        case 8:
          ...
          if (!(_context.t0 !== home_assistant_js_websocket__WEBPACK_IMPORTED_MODULE_0__["ERR_INVALID_AUTH"])) {
            _context.next = 12;
            break;
          }
        ...
        case 12:
          ...
          _context.next = 15;
          return regeneratorRuntime.awrap(authProm());
...
window.hassConnection.then(function (_ref2) {
  var conn = _ref2.conn;
...
window.addEventListener("error", function (e) {
  ...
  if (homeAssistant && homeAssistant.hass && homeAssistant.hass.callService) {
    homeAssistant.hass.callService("system_log", "write", {
      logger: "frontend.".concat( true ? "js_dev" : undefined, ".").concat("es5", ".").concat("20191119.0".replace(".", "")),
      message: "".concat(e.filename, ":").concat(e.lineno, ":").concat(e.colno, " ").concat(e.message)
    });
  }
});
