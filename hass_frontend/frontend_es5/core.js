  ...
  var s,
    ...
    return {
      ...
      action: function action(t) {
        ...
        return function () {
          for (var n = arguments, s = [e], o = 0; o < arguments.length; o++) {
            s.push(n[o]);
          }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return Object(home_assistant_js_websocket__WEBPACK_IMPORTED_MODULE_0__["createConnection"])({
              auth: auth
            });
...
window.addEventListener("error", function (e) {
  ...
  if (homeAssistant && homeAssistant.hass && homeAssistant.hass.callService) {
    homeAssistant.hass.callService("system_log", "write", {
      logger: "frontend.".concat( true ? "js_dev" : undefined, ".").concat("es5", ".").concat("20190604.0".replace(".", "")),
