(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["hui-dialog-move-card-view"],{
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject2(), this._openedChanged, this._params.lovelace.config.views.map(function (view, index) {
          return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject3(), _this2._params.path[0] === index, _this2._moveCard, index, view.title);
        }));
      }
    }, {
      kind: "get",
      ...
      value: function _moveCard(e) {
        var newView = e.currentTarget.index;
        ...
        lovelace.saveConfig(Object(_config_util__WEBPACK_IMPORTED_MODULE_3__["moveCard"])(lovelace.config, path, [newView]));
...
//# sourceMappingURL=hui-dialog-move-card-view.chunk.js.map