...
var cardConfigStruct = Object(_common_structs_struct__WEBPACK_IMPORTED_MODULE_1__["struct"])({
  type: "string",
  entity: "string?"
});
var HuiMediaControlCardEditor = _decorate([Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["customElement"])("hui-media-control-card-editor")], function (_initialize, _LitElement) {
  var HuiMediaControlCardEditor =
  /*#__PURE__*/
  function (_LitElement2) {
    ...
    function HuiMediaControlCardEditor() {
      ...
      _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(HuiMediaControlCardEditor)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject2(), this.hass.localize("ui.panel.lovelace.editor.card.generic.entity"), this.hass.localize("ui.panel.lovelace.editor.card.config.required"), this.hass, this._entity, "entity", this._valueChanged);
      }
    }, {
      kind: "method",
      key: "_valueChanged",
