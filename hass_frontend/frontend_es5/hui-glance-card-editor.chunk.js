(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["hui-glance-card-editor"],{
...
var entitiesConfigStruct = _common_structs_struct__WEBPACK_IMPORTED_MODULE_10__["struct"].union([{
  entity: "entity-id",
  name: "string?",
  icon: "icon?"
}, "entity-id"]);
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject2(), _config_elements_style__WEBPACK_IMPORTED_MODULE_13__["configElementStyle"], this._title, "title", this._valueChanged, this.hass, this._theme, "theme", this._valueChanged, this._columns, "columns", this._valueChanged, this._show_name !== false, "show_name", this._valueChanged, this._show_icon !== false, "show_icon", this._valueChanged, this._show_state !== false, "show_state", this._valueChanged, this.hass, this._configEntities, this._valueChanged);
      }
    }, {
      kind: "method",
      key: "_valueChanged",
...
//# sourceMappingURL=hui-glance-card-editor.chunk.js.map