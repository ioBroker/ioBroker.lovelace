(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["onboarding-integrations"],{
...
var loadConfigFlowDialog = function loadConfigFlowDialog() {
  return Promise.all(/*! import() | dialog-config-flow */[__webpack_require__.e("vendors~dialog-config-flow~hui-dialog-edit-card~hui-dialog-edit-lovelace~hui-dialog-edit-view~hui-di~60dfacf3"), __webpack_require__.e("vendors~dialog-config-flow~more-info-dialog~notification-manager~panel-lovelace"), __webpack_require__.e("vendors~dialog-config-flow~more-info-dialog~onboarding-core-config~panel-lovelace"), __webpack_require__.e("vendors~dialog-config-flow~more-info-dialog~panel-lovelace"), __webpack_require__.e("vendors~dialog-config-flow~more-info-dialog~onboarding-core-config"), __webpack_require__.e("vendors~dialog-config-flow~more-info-dialog"), __webpack_require__.e("vendors~dialog-config-flow~panel-lovelace"), __webpack_require__.e("dialog-config-flow~more-info-dialog~panel-lovelace"), __webpack_require__.e("dialog-config-flow")]).then(__webpack_require__.bind(null, /*! ./dialog-config-flow */ "./src/dialogs/config-flow/dialog-config-flow.ts"));
};
  ...
  return {
    ...
    d: [{
      ...
      value: function connectedCallback() {
        ...
        this.hass.connection.subscribeEvents(Object(_common_util_debounce__WEBPACK_IMPORTED_MODULE_6__["debounce"])(function () {
          return _this2._loadData();
        }, 500), "config_entry_discovered").then(function (unsub) {
      ...
      value: function render() {
        ...
        var discovered = this._discovered.map(function (flow) {
          var title = Object(_data_config_entries__WEBPACK_IMPORTED_MODULE_3__["localizeConfigFlowTitle"])(_this3.hass.localize, flow);
          ...
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.next = 2;
                  return Promise.all([Object(_data_config_entries__WEBPACK_IMPORTED_MODULE_3__["getConfigFlowsInProgress"])(this.hass), Object(_data_config_entries__WEBPACK_IMPORTED_MODULE_3__["getConfigEntries"])(this.hass)]);
          ...
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  _context2.next = 2;
                  return Object(_data_onboarding__WEBPACK_IMPORTED_MODULE_8__["onboardIntegrationStep"])(this.hass, {
...
//# sourceMappingURL=onboarding-integrations.chunk.js.map