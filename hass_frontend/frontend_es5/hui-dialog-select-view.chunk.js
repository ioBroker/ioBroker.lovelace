...
var HuiDialogSelectView = _decorate([Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["customElement"])("hui-dialog-select-view")], function (_initialize, _LitElement) {
  ...
  function (_LitElement2) {
    ...
    function HuiDialogSelectView() {
      ...
      _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(HuiDialogSelectView)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  return {
    ...
    d: [{
      ...
      value: function updated(changedProps) {
        ...
        Object(_common_dom_toggle_attribute__WEBPACK_IMPORTED_MODULE_2__["toggleAttribute"])(this, "hide-icons", this._params.lovelace.config ? !this._params.lovelace.config.views.some(function (view) {
          return view.icon;
        }) : true);
      }
    }, {
      ...
      value: function render() {
        ...
        return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject2(), this._openedChanged, this._params.lovelace.config, this._selectView);
      }
    }, {
      kind: "get",
      key: "_dialog",
