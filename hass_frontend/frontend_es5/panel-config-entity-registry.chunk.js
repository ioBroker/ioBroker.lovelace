(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["panel-config-entity-registry"],{
...
/* harmony import */ var _data_entity_registry__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../data/entity_registry */ "./src/data/entity_registry.ts");
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject2(), this.hass.localize("ui.panel.config.entity_registry.caption"), this.isWide, this.hass.localize("ui.panel.config.entity_registry.picker.header"), this.hass.localize("ui.panel.config.entity_registry.picker.introduction"), this.hass.localize("ui.panel.config.entity_registry.picker.introduction2"), this.hass.localize("ui.panel.config.entity_registry.picker.integrations_page"), this._entities.map(function (entry) {
          var state = _this2.hass.states[entry.entity_id];
          return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject3(), _this2._openEditEntry, entry, state ? Object(_common_entity_state_icon__WEBPACK_IMPORTED_MODULE_9__["default"])(state) : Object(_common_entity_domain_icon__WEBPACK_IMPORTED_MODULE_8__["default"])(Object(_common_entity_compute_domain__WEBPACK_IMPORTED_MODULE_10__["default"])(entry.entity_id)), Object(_data_entity_registry__WEBPACK_IMPORTED_MODULE_3__["computeEntityRegistryName"])(_this2.hass, entry) || _this2.hass.localize("ui.panel.config.entity_registry.picker.unavailable"), entry.entity_id, entry.platform);
        }));
      }
    }, {
      kind: "method",
      ...
      value: function updated(changedProps) {
        ...
        if (!this._unsubEntities) {
          this._unsubEntities = Object(_data_entity_registry__WEBPACK_IMPORTED_MODULE_3__["subscribeEntityRegistry"])(this.hass.connection, function (entities) {
            _this3._entities = entities.sort(function (ent1, ent2) {
              return Object(_common_string_compare__WEBPACK_IMPORTED_MODULE_13__["compare"])(ent1.entity_id, ent2.entity_id);
            });
          });
        }
      }
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      _context.next = 2;
                      return Object(_data_entity_registry__WEBPACK_IMPORTED_MODULE_3__["updateEntityRegistryEntry"])(_this4.hass, entry.entity_id, updates);

                    case 2:
                      updated = _context.sent;
                      _this4._entities = _this4._entities.map(function (ent) {
              ...
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      if (confirm("Are you sure you want to delete this entry?\n\nDeleting an entry will not remove the entity from ioBroker. To do this, you will need to remove the integration \"".concat(entry.platform, "\" from ioBroker."))) {
                        _context2.next = 2;
                        break;
                      }
                    ...
                    case 2:
                      _context2.prev = 2;
                      _context2.next = 5;
                      return Object(_data_entity_registry__WEBPACK_IMPORTED_MODULE_3__["removeEntityRegistryEntry"])(_this4.hass, entry.entity_id);

                    case 5:
                      _this4._entities = _this4._entities.filter(function (ent) {
                        return ent !== entry;
                      });
...
//# sourceMappingURL=panel-config-entity-registry.chunk.js.map