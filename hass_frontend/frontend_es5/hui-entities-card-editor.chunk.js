(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["hui-entities-card-editor"],{
...
var entitiesConfigStruct = _common_structs_struct__WEBPACK_IMPORTED_MODULE_11__["struct"].union([{
  entity: "entity-id",
  name: "string?",
  icon: "icon?"
}, "entity-id"]);
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject2(), _config_elements_style__WEBPACK_IMPORTED_MODULE_13__["configElementStyle"], this._title, "title", this._valueChanged, this.hass, this._theme, "theme", this._valueChanged, this._config.show_header_toggle !== false, "show_header_toggle", this._valueChanged, this.hass, this._configEntities, this._valueChanged);
      }
    }, {
      kind: "method",
      key: "_valueChanged",
      value: function _valueChanged(ev) {
        ...
        Object(_common_dom_fire_event__WEBPACK_IMPORTED_MODULE_12__["fireEvent"])(this, "config-changed", {
          config: this._config
        });
      }
    }]
...
//# sourceMappingURL=hui-entities-card-editor.chunk.js.map