(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["entity-registry-detail-dialog"],{
...
function (_LitElement) {
  _inherits(DialogEntityRegistryDetail, _LitElement);
  ...
  function DialogEntityRegistryDetail() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_entityId", void 0);

    _defineProperty(_assertThisInitialized(_this), "_error", void 0);

    _defineProperty(_assertThisInitialized(_this), "_params", void 0);

    _defineProperty(_assertThisInitialized(_this), "_submitting", void 0);

    return _this;
  }

  _createClass(DialogEntityRegistryDetail, [{
    key: "showDialog",
    value: function () {
    ...
    value: function render() {
      ...
      var invalidDomainUpdate = Object(_common_entity_compute_domain__WEBPACK_IMPORTED_MODULE_5__["default"])(this._entityId.trim()) !== Object(_common_entity_compute_domain__WEBPACK_IMPORTED_MODULE_5__["default"])(this._params.entry.entity_id);
      return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject2(), this._openedChanged, entry.entity_id, !stateObj ? Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject3(), this.hass.localize("ui.panel.config.entity_registry.editor.unavailable")) : "", this._error ? Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject4(), this._error) : "", this._name, this._nameChanged, this.hass.localize("ui.dialogs.more_info_settings.name"), stateObj ? Object(_common_entity_compute_state_name__WEBPACK_IMPORTED_MODULE_6__["default"])(stateObj) : "", this._submitting, this._entityId, this._entityIdChanged, this.hass.localize("ui.dialogs.more_info_settings.entity_id"), invalidDomainUpdate, this._submitting, this._deleteEntry, this._submitting, this.hass.localize("ui.panel.config.entity_registry.editor.delete"), this._updateEntry, invalidDomainUpdate || this._submitting, this.hass.localize("ui.panel.config.entity_registry.editor.update"));
    }
  }, {
    key: "_nameChanged",
...
//# sourceMappingURL=entity-registry-detail-dialog.chunk.js.map