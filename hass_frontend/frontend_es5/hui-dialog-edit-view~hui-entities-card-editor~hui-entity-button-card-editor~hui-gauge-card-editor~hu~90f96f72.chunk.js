...
var HuiEntityEditor = _decorate([Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["customElement"])("hui-entity-editor")], function (_initialize, _LitElement) {
  var HuiEntityEditor =
  /*#__PURE__*/
  function (_LitElement2) {
    _inherits(HuiEntityEditor, _LitElement2);
    ...
    function HuiEntityEditor() {
      ...
      _classCallCheck(this, HuiEntityEditor);

      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }

      _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(HuiEntityEditor)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject2(), this.label || this.hass.localize("ui.panel.lovelace.editor.card.generic.entities") + " (" + this.hass.localize("ui.panel.lovelace.editor.card.config.required") + ")", this.entities.map(function (entityConf, index) {
          return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject3(), _this2.hass, entityConf.entity, index, _this2._valueChanged, index, _this2._entityDown, index === _this2.entities.length - 1, index, _this2._entityUp, index === 0);
      ...
      value: function _entityUp(ev) {
        ...
        var _ref = [newEntities[target.index], newEntities[target.index - 1]];
        newEntities[target.index - 1] = _ref[0];
        newEntities[target.index] = _ref[1];
        Object(_common_dom_fire_event__WEBPACK_IMPORTED_MODULE_2__["fireEvent"])(this, "entities-changed", {
      ...
      value: function _entityDown(ev) {
        var target = ev.target;
        var newEntities = this.entities.concat();
        var _ref2 = [newEntities[target.index], newEntities[target.index + 1]];
        newEntities[target.index + 1] = _ref2[0];
        newEntities[target.index] = _ref2[1];
        Object(_common_dom_fire_event__WEBPACK_IMPORTED_MODULE_2__["fireEvent"])(this, "entities-changed", {
          entities: newEntities
        });
      }
