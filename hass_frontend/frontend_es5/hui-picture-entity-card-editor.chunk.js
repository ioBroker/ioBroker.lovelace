...
var HuiPictureEntityCardEditor = _decorate([Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["customElement"])("hui-picture-entity-card-editor")], function (_initialize, _LitElement) {
  var HuiPictureEntityCardEditor =
  /*#__PURE__*/
  function (_LitElement2) {
    _inherits(HuiPictureEntityCardEditor, _LitElement2);
    ...
    function HuiPictureEntityCardEditor() {
      ...
      _classCallCheck(this, HuiPictureEntityCardEditor);

      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }

      _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(HuiPictureEntityCardEditor)).call.apply(_getPrototypeOf2, [this].concat(args)));
      ...
      value: function _valueChanged(ev) {
        ...
        if (target.configValue) {
          if (value === "") {
            ...
            this._config = Object.assign({}, this._config, _defineProperty({}, target.configValue, target.checked !== undefined ? target.checked : value ? value : target.config));
          }
        }
