  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject2(), _config_elements_style__WEBPACK_IMPORTED_MODULE_7__["configElementStyle"], this._name, "name", this._valueChanged, this.hass, this._entity, "entity", this._valueChanged, this._unit, "unit", this._valueChanged, this.hass, this._theme, "theme", this._valueChanged, this._min, "min", this._valueChanged, this._max, "max", this._valueChanged, this._useSeverity !== false, this._toggleSeverity, this._severity ? this._severity.green : 0, "green", this._severityChanged, this._severity ? this._severity.yellow : 0, "yellow", this._severityChanged, this._severity ? this._severity.red : 0, "red", this._severityChanged);
      }
    }, {
      kind: "get",
      "static": true,
