...
var CORE_PAGES = ["core", "customize", "entity_registry", "area_registry"];
/*
 * @appliesMixin LocalizeMixin
...
function (_LocalizeMixin) {
  _inherits(HaConfigNavigation, _LocalizeMixin);

  function HaConfigNavigation() {
    _classCallCheck(this, HaConfigNavigation);

    return _possibleConstructorReturn(this, _getPrototypeOf(HaConfigNavigation).apply(this, arguments));
  }

  _createClass(HaConfigNavigation, [{
    key: "_computeLoaded",
    value: function _computeLoaded(hass, page) {
      return CORE_PAGES.includes(page) || Object(_common_config_is_component_loaded__WEBPACK_IMPORTED_MODULE_7__["default"])(hass, page);
    }
  }, {
    key: "_computeCaption",
    value: function _computeCaption(page, localize) {
      return localize("ui.panel.config.".concat(page, ".caption"));
    }
  }, {
    key: "_computeDescription",
    value: function _computeDescription(page, localize) {
      return localize("ui.panel.config.".concat(page, ".description"));
    }
  }, {
    key: "_navigate",
...
}(Object(_mixins_localize_mixin__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_mixins_navigate_mixin__WEBPACK_IMPORTED_MODULE_5__["default"])(_polymer_polymer_polymer_element__WEBPACK_IMPORTED_MODULE_4__["PolymerElement"])));
