...
* (Garfonso/Claude) Custom cards: the file selector deletes a card now, the overview of the installed cards says so in its title, and a link leads to the cards folder in the ioBroker file browser.
