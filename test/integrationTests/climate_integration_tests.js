    ...
    suite('climate', getHarness => {
        ...
        describe('thermostats', async () => {
            ...
            it('should create climate with current temp', async () => {
                ...
                expect(temperatureAttribute).to.be.ok;
                expect(temperatureAttribute).to.have.property('getId', `${deviceId}.target`);
                const currentTemperatureAttribute = entity.context.ATTRIBUTES.find(
                    a => a.attribute === 'current_temperature',
                );
            ...
            initialStates.push({
                id: 'adapter.0.climate.thermostat.target_power_current_temp_humidity.power',
                val: true,
            });
            ...
            it('should create climate with only target temp and check if reacting to target changes', async () => {
                ...
                await tools.validateUIInput(
                    ...
                    `${deviceId}.target`,
                    state => expect(state.val).to.be.equal(35),
                );
            });
            ...
            it('should create climate supporting mode with many modes', async () => {
                ...
                await tools.validateUIInput(
                    ...
                    `${deviceId}.mode`,
                    state => expect(state.val).to.be.equal(0),
                );
                await tools.validateUIInput(
                    harness,
                    entity,
                    ...
                    `${deviceId}.mode`,
                    state => expect(state.val).to.be.equal(6),
                );
                await tools.validateUIInput(
                    harness,
                    entity,
                    ...
                    `${deviceId}.mode`,
                    state => expect(state.val).to.be.equal(7),
                );
            });
            ...
            initialStates.push(
                { id: 'adapter.0.climate.thermostat.ModeAndPower.mode', val: 0 },
            ...
            it('should create climate with combined mode and power attribute', async () => {
                ...
                await tools.validateUIInput(
                    ...
                    `${deviceId}.mode`,
                    state => expect(state.val).to.equal(1),
                );
                await tools.validateUIInput(
                    harness,
                    entity,
                    ...
                    `${deviceId}.mode`,
                    state => expect(state.val).to.equal(2),
                );
                await tools.validateUIInput(
                    harness,
                    entity,
                ...
                await tools.validateUIInput(
                    ...
                    `${deviceId}.power`,
                    state => expect(state.val).to.be.false,
                );
                await tools.validateUIInput(
                    harness,
                    entity,
                    ...
                    `${deviceId}.power`,
                    state => expect(state.val).to.be.true,
                );
            });
            ...
            initialStates.push(
                { id: 'adapter.0.climate.thermostat.WithBoostAndParty.boost', val: false },
        ...
        describe('airCondition', async () => {
            ...
            initialStates.push(
                { id: 'adapter.0.aircondition.ModeAndFan.mode', val: 1 },
            ...
            it('should create climate with mode and fan', async () => {
                ...
                expect(entity.attributes.fan_modes).to.have.members([
                    'AUTO',
                    'HIGH',
                    'LOW',
                    'MEDIUM',
            ...
            initialStates.push(
                { id: 'adapter.0.aircondition.ModeAndSwing.mode', val: 1 },
            ...
            initialStates.push(
                { id: 'adapter.0.aircondition.mode_full_and_fan_without_states.mode', val: 1 },
            ...
            initialStates.push(
                { id: 'adapter.0.aircondition.mode_full_and_swing_without_states.mode', val: 1 },
            ...
            initialStates.push(
                { id: 'adapter.0.aircondition.BinarySwing.mode', val: 1 },
            ...
            initialStates.push(
                { id: 'adapter.0.aircondition.Full.mode', val: 1 },
