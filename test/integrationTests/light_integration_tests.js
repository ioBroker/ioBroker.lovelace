...
exports.runTests = function (suite) {
    suite('light', getHarness => {
        ...
        describe('control tests', () => {
            ...
            it('entity for only on/off should be created and switched on/off', async () => {
                ...
                await tools.validateUIInput(
                    ...
                    `${deviceId}.state`,
                    state => expect(state.val).to.equal(false),
                );
            });
            ...
            it('entity for only brightness', async () => {
                ...
                await tools.validateUIInput(
                    ...
                    `${deviceId}.brightness`,
                    state => expect(state.val).to.greaterThanOrEqual(50),
                );
                await tools.delay(500); //wait a little, because brightness will be set two times in this case!
                await tools.validateUIInput(
                    harness,
            ...
            it('entity for brightness with modified min/max', async () => {
                ...
                await tools.validateUIInput(
                    ...
                    `${deviceId}.brightness`,
                    state => expect(state.val).to.equal(10),
                );
                await tools.validateUIInput(
                    harness,
                    entity,
                    ...
                    `${deviceId}.brightness`,
                    state => expect(state.val).to.equal(110),
                );
                await tools.validateUIInput(
                    harness,
                    entity,
                    ...
                    `${deviceId}.brightness`,
                    state => expect(state.val).to.greaterThanOrEqual(60),
                );
                await tools.validateUIInput(
                    harness,
                    entity,
            ...
            initialStates.push(
                { id: 'adapter.0.light.BrightnessWithState.brightness', val: 0 },
            ...
            initialStates.push(
                { id: 'adapter.0.light.BrightnessWithActual.brightness_actual', val: 50 },
            ...
            initialStates.push(
                { id: 'adapter.0.light.ColorTemp.brightness', val: 0 },
            ...
            it('colortemp kelvin', async () => {
                ...
                await tools.validateUIInput(
                    ...
                    `${deviceId}.ct`,
                    state => expect(state.val).to.equal(3000),
                );
                await tools.validateUIInput(
                    harness,
                    entity,
                    ...
                    `${deviceId}.ct`,
                    state => expect(state.val).to.equal(2200),
                );
                expect(entity).to.have.nested.property('attributes.color_mode', 'color_temp');
            });
            ...
            it('colortemp mired', async () => {
                ...
                await tools.validateUIInput(
                    ...
                    `${deviceId}.ct`,
                    state => expect(state.val).to.equal(183),
                );
                await tools.validateUIInput(
                    harness,
                    entity,
                    ...
                    `${deviceId}.ct`,
                    state => expect(state.val).to.equal(390),
                );
                expect(entity).to.have.nested.property('attributes.color_mode', 'color_temp');
            });
            ...
            it('colortemp unknown with kelvin', async () => {
                ...
                await tools.validateUIInput(
                    ...
                    `${deviceId}.ct`,
                    state => expect(state.val).to.equal(6400),
                );
                expect(entity).to.have.nested.property('attributes.color_mode', 'color_temp');
            });
            ...
            it('colortemp unknown with mireds', async () => {
                ...
                await tools.validateUIInput(
                    ...
                    `${deviceId}.ct`,
                    state => expect(state.val).to.equal(1e6 / 2200),
                );
                await tools.validateUIInput(
                    harness,
                    entity,
                    ...
                    `${deviceId}.ct`,
                    state => expect(state.val).to.equal(1e6 / 6500),
                );
            });
            ...
            initialStates.push(
                { id: 'adapter.0.light.rgbSingle.color', val: '#FF0080' },
                { id: 'adapter.0.light.rgbSingle.state', val: true },
            );
            it('color lamp rgbSingle', async () => {
                ...
                await tools.validateUIInput(
                    ...
                    `${deviceId}.color`,
                    state => expect(state.val).to.equal('#00FF00'),
                );
                await tools.validateUIInput(
                    harness,
                    entity,
                    ...
                    `${deviceId}.color`,
                    state => expect(state.val).to.equal('#FF8080'),
                );
                await tools.validateUIInput(
                    harness,
                    entity,
                    ...
                    `${deviceId}.color`,
                    state => expect(state.val).to.equal('#FFFFFF'),
                );
                expect(entity).to.have.nested.property('attributes.color_mode', 'rgb');
            });
            ...
            initialStates.push(
                { id: 'adapter.0.light.Hue.hue', val: 0 },
            ...
            it('color lamp hue and saturation', async () => {
                ...
                await tools.validateMultiUIInput(
                    harness,
                    entity,
                    m => {
                        m.domain = 'light';
                    ...
                    [`${deviceId}.saturation`, `${deviceId}.hue`],
                    result => {
            ...
            it('color lamp rgbSingle as array string', async () => {
                ...
                await tools.validateUIInput(
                    ...
                    `${deviceId}.color`,
                    state => expect(state.val).to.equal('0,255,0'),
                );
                await tools.validateUIInput(
                    harness,
                    entity,
                    ...
                    `${deviceId}.color`,
                    state => expect(state.val).to.equal('255,128,128'),
                );
                await tools.validateUIInput(
                    harness,
                    entity,
                    ...
                    `${deviceId}.color`,
                    state => expect(state.val).to.equal('255,255,255'),
                );
                expect(entity).to.have.nested.property('attributes.color_mode', 'rgb');
            });
            ...
            initialStates.push(
                { id: 'adapter.0.light.rgbw.red', val: 0 },
            ...
            it('color lamp rgbw', async () => {
                ...
                await tools.validateMultiUIInput(
                    ...
                    [`${deviceId}.red`, `${deviceId}.green`, `${deviceId}.blue`, `${deviceId}.white`],
                    result => {
            ...
            it('custom brightness should control on/off correctly', async () => {
                ...
                await tools.validateUIInput(
                    ...
                    deviceId,
                    state => expect(state.val).to.equal(78),
                );
                await tools.validateUIInput(
                    harness,
                    entity,
        ...
        describe('detect light from adapters', () => {
            ...
            initialStates.push(
                { id: 'zigbee.0.zigbeeColor.state', val: true },
            ...
            initialStates.push(
                { id: 'adapter.0.light.wled_rgbw.on', val: true },
