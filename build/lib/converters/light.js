...
function lightAddColorTemperature(states, objects, entity) {
  ...
  entity.attributes.max_color_temp_kelvin = (_b = tempCommon.max) != null ? _b : iobMaxValueKelvin;
  entity.attributes.min_color_temp_kelvin = (_c = tempCommon.min) != null ? _c : iobMinValueKelvin;
  ...
  if (attribute.convert_to_mired) {
    entity.attributes.max_mireds = (_d = tempCommon.max) != null ? _d : 1e6 / entity.attributes.min_color_temp_kelvin;
    entity.attributes.min_mireds = (_e = tempCommon.min) != null ? _e : 1e6 / entity.attributes.max_color_temp_kelvin;
  } else {
...
function fillLightEntityFromStates(states, objects, entity) {
  ...
  if (!entity.context.STATE.isBoolean) {
    const stateObj = objects[(_i = states.state) != null ? _i : ""];
    const stateCommon = (_j = stateObj == null ? void 0 : stateObj.common) != null ? _j : {};
    entity.context.COMMANDS[entity.context.COMMANDS.length - 1].on = (_k = stateCommon.max) != null ? _k : 100;
    const offVal = (_l = stateCommon.min) != null ? _l : 0;
    entity.context.COMMANDS.push({
      service: "turn_off",
      off: offVal,
      setId: entity.context.STATE.setId,
