...
class WebServer {
    ...
    _readObjects() {
        return new Promise(resolve => {
            ...
            this.adapter.objects.getObjectView('system', 'state', params, (err, _states) => {
                this.adapter.objects.getObjectView('system', 'channel', params, (err, _channels) => {
                    this.adapter.objects.getObjectView('system', 'device', params, (err, _devices) => {
    ...
    _init() {
        ...
        if (this.adapter.config.aliasOnly) {
            this.adapter.subscribeForeignObjects('alias.0.*');
        } else {
