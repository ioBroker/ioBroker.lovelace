...
class WebServer {
            ...
            if (client.__templates && client.readyState === WebSocket.OPEN) {
                ...
                client.__templates.forEach(t => {
                    if (t.ids.includes(id)) {
                        ...
                        if (this.templateStates[id] && this.templateStates[id].val !== _state.val) {
    ...
    _init() {
        ...
        this._app.get('/api/history/period/:start', (req, res) => {
            ...
            let user = req._user || this.config.defaultUser;
    ...
    _initConnection(ws) {
        ...
        ws.on('message', message => {
            ...
            if (message.type === 'unsubscribe_events') {
                ...
                if (message.event_type && ws._subscribes[message.event_type]) {
