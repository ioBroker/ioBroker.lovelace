...
class WebServer {
     ...
     * @param roomName room name of the device
     * @param funcName function name of the device
     * @param objects all ioBroker objects
     * @returns {*[]} array of generated entities
     */
    _generateEntitiesFromIndicators(mainEntity, control, friendlyName, roomName, funcName, objects) {
        const entities = [];
