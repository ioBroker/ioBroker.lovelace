const binary_sensor = require('./binary_sensor');
...
exports.processWindowTilt = function (id, control, name, room, func, _obj, objects) {
    ...
    return [entity, binary_sensor.processBattery.call(this,control, name, room, func, objects)];
};
...
exports.processHumidity = function (id, control, name, room, func, _obj, objects) {
    ...
    if (state) {
        ...
        this._addID2entity(state.id, entity);
        return [entity, binary_sensor.processBattery(this, control, name, room, func, objects)];
    }
    return [];
};
...
exports.processTemperature = function (id, control, name, room, func, _obj, objects) {
    ...
    return [entity, entityHum, binary_sensor.processBattery.call(this, control, name, room, func, objects)];
};
