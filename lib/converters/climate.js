...
function fillClimateEntityFromStates(states, objects, entity, iobType) {
    ...
    if (states.swing_mode) {
        ...
        if (swing_obj && swing_obj.common && swing_obj.common.states) {
            ...
            swing_attr.states = {0: 'AUTO', 1: 'HORIZONTAL', 2: 'STATIONARY', 3: 'VERTICAL'}; //as we don't know a translation, prevent errors later on.
            entity.attributes.swing_modes = ['AUTO', 'HORIZONTAL', 'STATIONARY', 'VERTICAL']; //add some modes to dropdown...
        }
