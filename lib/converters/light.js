...
function _lightAdvancedAddColorTemperature(states, objects, entity) {
    ...
    if (states.color_temp) {
        ...
        attribute.convert_to_mired = tempObj && tempObj.common ? (tempObj.common.unit === 'mired' || !tempObj.common.unit) : false;
        ...
        if (attribute.convert_to_mired || entity.attributes.max_color_temp_kelvin < 1000) {
            ...
            entity.attributes.min_color_temp_kelvin = tempObj && tempObj.common && tempObj.common.max ? 1e6 / tempObj.common.max : iobMaxValueKelvin;
        }
