...
function addBlindLevel(entities, control, objects, name, id, room, func, _obj) {
    ...
    if (state && state.id) {
        ...
        if (state && state.id) {
            ...
            const entitySlider = utils.processCommon(entity.attributes.friendly_name, room, func, _obj, 'input_number');
...
exports.processBlind = function(id, control, name, room, func, _obj, objects) {
    const entity = utils.processCommon(name, room, func, _obj, 'cover');
    ...
    if(addBlindLevel(entities, control, objects, 'SET', id, room, func, _obj)) {
