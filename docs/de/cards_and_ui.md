...
Alle Dateien aus dem `cards`-Verzeichnis werden automatisch eingebunden, und der Adapter überwacht dieses Verzeichnis: Eine Karte, die hier, im ioBroker-Dateibrowser oder über die Kommandozeile hinzugefügt, ersetzt oder gelöscht wird, übernimmt er von selbst. Zum Nutzen einer neu hinzugefügten Karte danach den Browser neu laden - ein Adapter-Neustart ist nicht nötig. `Karten neu einlesen` im Reiter macht dasselbe auf Wunsch, falls eine Änderung doch einmal nicht bemerkt wird.
